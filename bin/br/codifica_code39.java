 ...
 * ********************************************************************** *
 * Descrição: Codificador de texto para Code 39.                          *
 **************************************************************************/
...
//Para tratamento geral de excessões
...
public class codifica_code39
{

    // Processo principal de codificação para Code39 (Tipo [A] - Apenas numérico, [B] - Apenas alfanumérico, [C] - Numérico e alfanumérico
    public static BitMatrix code39(String   p_chave
			                   	  ,String   p_extensao
			                   	  ,int      p_altura
			                   	  ,int      p_largura
			              	   	  )
    {
        ...
        try
        {
        	...
        	Writer v_escritor = new Code39Writer();
