 ...
 * ********************************************************************** *
 * Descrição: Codificador de texto para Code 128.                         *
 **************************************************************************/
...
public class codifica_code128
{

    // Processo principal de codificação para Code128 (Tipo [A] - Apenas numérico, [B] - Apenas alfanumérico, [C] - Numérico e alfanumérico
    public static BitMatrix code128(String   p_chave
				                   ,String   p_extensao
				                   ,int      p_altura
				                   ,int      p_largura
				              	   )
    {
        ...
        try
        {
        	...
        	Writer v_escritor = new Code128Writer();
