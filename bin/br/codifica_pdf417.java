 ...
 * ********************************************************************** *
 * Descrição: Codificador de texto para pdf417                            *
 **************************************************************************/
package br;
...
public class codifica_pdf417
{
    // Processo principal de codificação para pdf417
    public static BitMatrix pdf417(String   p_chave
			                   	  ,String   p_extensao
			                   	  ,int      p_altura
			                   	  ,int      p_largura
			              	   	  )
