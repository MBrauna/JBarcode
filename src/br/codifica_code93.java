 ...
 * ********************************************************************** *
 * Descrição: Codificador de texto para Code 93.                         *
 **************************************************************************/
...
//Para tratamento geral de erros
...
public class codifica_code93
{
    // Processo principal de codificação para Code 93 (Apenas numérico)
    public static BitMatrix code93(String   p_chave
			                      ,String   p_extensao
			                      ,int      p_altura
			                      ,int      p_largura
			              	      )
    {
        ...
        // Tratamento para a entrada da chave à ser criptografada
        try
        {
        ...
        try
        {
        	...
        	Writer v_escritor  = new Code93Writer();
