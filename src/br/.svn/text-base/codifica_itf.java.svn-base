 ...
 * ********************************************************************** *
 * Descrição: Codificador de texto para ITF                               *
 **************************************************************************/
...
public class codifica_itf
{
    // Processo principal de codificação para ITF
    public static BitMatrix itf(String   p_chave
			                   ,String   p_extensao
			                   ,int      p_altura
			                   ,int      p_largura
			              	   )
    {
        ...
        try
        {
        	...
        	Writer v_escritor  = new ITFWriter();
