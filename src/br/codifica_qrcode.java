...
//Para tratamento de excessões
import java.io.UnsupportedEncodingException;


public class codifica_qrcode
{

    // Processo principal de codificação para QrCode
    public static BitMatrix qrcode(String   p_chave
			                      ,String   p_extensao
			                      ,int      p_altura
			                      ,int      p_largura
			              	      )
    {
        ...
        {
        	// Emite um erro caso não seja possível criar o arquivo no diretório informado
        	System.out.println(e.getMessage());
        }
        
        // Se nenhum dos procedimentos acima encerrar o processo ...
        // Finaliza e marca como falha (Retorno nulo).
        return null;
