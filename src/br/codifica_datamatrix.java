 ...
 * ********************************************************************** *
 * Descrição: Codificador de texto para DataMatrix.                       *
 **************************************************************************/
package br;
...
public class codifica_datamatrix
{
    // Processo principal de codificação para DataMatrix
    public static BitMatrix datamatrix(String   p_chave
				                      ,String   p_extensao
				                      ,int      p_altura
				                      ,int      p_largura
				              	   	  )
